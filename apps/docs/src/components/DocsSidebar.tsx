...
const navigation: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "useIsDesktop", href: "/docs/hooks/use-is-desktop" },
      { title: "useIsMobile", href: "/docs/hooks/use-is-mobile" },
      { title: "useIsTablet", href: "/docs/hooks/use-is-tablet" },
      ...
      { title: "usePrefersDark", href: "/docs/hooks/use-prefers-dark" },
